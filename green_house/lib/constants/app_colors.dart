...
class AppColors {
  static const Color primaryColor = Color(0xff71A901);
  ...
  static const Color greyLightColor = Color(0xff3C3C43);
  static const Color dividerColor = Color(0xff253274);
  static const Color blueColor = Color.fromARGB(255, 51, 95, 255);
